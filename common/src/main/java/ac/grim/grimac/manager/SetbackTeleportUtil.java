...
public class SetbackTeleportUtil extends Check implements PostPredictionCheck {
    ...
    private void simulateFriction(Vector3dm vector) {
        ...
        if (player.wasTouchingWater) {
            ...
            PredictionEngineElytra.getElytraMovement(player, vector, ReachUtils.getLook(player, player.yaw, player.pitch)).multiply(player.stuckSpeedMultiplier).multiply(0F, 0F, 0F);
